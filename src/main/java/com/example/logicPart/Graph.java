...
public class Graph {
    public ArrayList<ArrayList<Pair<Float, Pair<String, Integer>>>> adj;
    ...
    public void addInGraph(int source, int destination, float price, float time, String mode) {
    ...
    public int minimumTimeRoute(int src, int desc) {
//    	int source = 1;
//    	int destination = 3;
